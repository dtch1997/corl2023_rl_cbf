    ...
    for global_step in range(args.total_timesteps):
        ...
        if global_step > args.learning_starts:
            ...
            if args.eval_frequency > 0 and global_step % args.eval_frequency == 0:
                ...
                barrier_validity = evaluator.calculate_validity(barrier_df, one_minus_alphas)
                for one_minus_alpha, validity in zip(one_minus_alphas, barrier_validity):
                    writer.add_scalar(f'eval/barrier/validity_oneminusalpha_{one_minus_alpha}', validity, global_step)
