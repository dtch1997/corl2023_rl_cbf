...
class DQNCartPoleVisualizer:
    ...
    def visualize(self, 
        ...
        theta_ax.scatter(state_hist[:,2], state_hist[:,3], c='k', s=1)
        ...
        x_ax.scatter(state_hist[:,0], state_hist[:,1], c='k', s=1)
...
if __name__ == "__main__":
    ...
    states = np.loadtxt(args.data_path)
    ...
    x_ax = axes[0]
    theta_ax = axes[1]
    x_ax.set_title(pathlib.Path(model_path).stem)
    fig = visualizer.visualize(model, states, x_ax, theta_ax)
