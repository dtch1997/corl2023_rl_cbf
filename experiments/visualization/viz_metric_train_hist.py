...
if __name__ == "__main__":
    ...
    mean = df[['exp_name', 'global_step', args.metric_name]].groupby(['exp_name', 'global_step']).mean()
    stdev = df[['exp_name', 'global_step', args.metric_name]].groupby(['exp_name', 'global_step']).std()
    ...
    df = df[['exp_name', 'global_step', args.metric_name, f'{args.metric_name}_mean', f'{args.metric_name}_stdev']]
